...
<head>
        ...
        <!-- Jquery filer css -->
        <link href="{{URL::to('public/backendAssets')}}/plugins/jquery.filer/css/jquery.filer.css" rel="stylesheet" />
        <link href="{{URL::to('public/backendAssets')}}/plugins/jquery.filer/css/themes/jquery.filer-dragdropbox-theme.css" rel="stylesheet" />
    ...
    <body class="fixed-left">
        ...
        <!-- Jquery filer js -->
        <script src="{{URL::to('public/backendAssets')}}/plugins/jquery.filer/js/jquery.filer.min.js"></script>

        <!-- page specific js -->
        <script src="{{URL::to('public/backendAssets')}}/assets/pages/jquery.property-add.init.js"></script>
